        const initialWords = [
            ...
            "RASPBERRY", "STRAWBERRY", "TANGERINE", "WATERMELON", "VANILLA",
            "PIZZA", "BURGER", "PASTA", "ICECREAM", "TACO",
            "BROWNIE", "CUPCAKE", "DUMPLING", "EGG", "FRUITCAKE",
            "GRANOLA", "HAMBURGER", "JELLY", "KETCHUP", "LASAGNA",
            "MEATBALL", "NOODLES", "OATMEAL", "QUICHE", "RAVIOLI",
            "SUSHI", "TORTILLA", "YOGURT", "ZUCCHINI", "AVOCADO",
            "BISCUIT", "CROISSANT", "DONUT", "GINGER",
            "JAM", "KALBI", "LOBSTER", "MOUSSE", "NACHOS",
            "OUTBACK", "POTATO", "QUINOA", "RICE", "SAUSAGE",
            "VERMICELLI", "WAFFLE", "XMAS COOKIES", "YAKITORI"
        ];
        ...
        document.getElementById('new-words').addEventListener('click', generateNewWords);
        ...
        function displayGrid() {
            ...
            grid.forEach((row, rowIndex) => {
                row.forEach((cell, colIndex) => {
                    ...
                    cellDiv.addEventListener('mouseenter', () => isSelecting && selectCell(cellDiv));
        ...
        function updateWordList() {
            ...
            wordListDiv.innerHTML = `<h2>Words to Find:</h2><ul>${words.map(word => `<li>${word}</li>`).join('')}</ul>`;
        }
