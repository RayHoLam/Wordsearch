const initialWords = ["APPLE", "BANANA", "CHERRY", "DURIAN", "FIG", "GRAPE", "HONEYDEW", "KIWI", "LEMON", "MANGO", "NECTARINE", "ORANGE", "PAPAYA", "QUINCE", "RASPBERRY", "TANGERINE", "VANILLA", "PIZZA", "BURGER", "PASTA", "ICECREAM", "TACO", "BROWNIE", "CUPCAKE", "DUMPLING", "EGG", "FRUITCAKE", "GRANOLA", "HAMBURGER", "JELLY", "KETCHUP", "LASAGNA", "MEATBALL", "NOODLES", "OATMEAL", "QUICHE", "RAVIOLI", "SUSHI", "TORTILLA", "YOGURT", "ZUCCHINI", "AVOCADO", "BISCUIT", "CROISSANT", "DONUT", "GINGER", "JAM", "KALBI", "LOBSTER", "MOUSSE", "NACHOS", "OUTBACK", "POTATO", "QUINOA", "RICE", "SAUSAGE", "VERMICELLI", "WAFFLE", "COOKIES", "YAKITORI"];
